...
**Statut :** draft consolidé v1.8 (revu localement le 2026-07-09 : réflexion + démarche en 5 phases sur la mise en œuvre des agents IA dans les équipes, §Modèles d'équipe ; réflexion sur la production de livrables PPT à partir d'un retour d'expérience VSCode3, §Workflows/iap-deck-builder)
