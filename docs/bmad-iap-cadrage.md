...
**Statut :** draft consolidé v1.6 (revu localement le 2026-07-07 : compteurs corrigés, redaction appliquée, dépendances externes versionnées, owners/échéances sur les points ouverts, module.yaml et gate DevOps tranchés)
